...
// onCreate(SQLiteDatabase arg0) , onUpgrade(SQLiteDatabase arg0, int oldversion, int newversion)
    ...
    private static final String TABLE_CONTACTS="reg";
    ...
    public void onCreate(SQLiteDatabase arg0) {
        ...
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
                + KEY_ID + " INTEGER PRIMARY KEY," + KEY_NAME + " TEXT,"+ PASS_WORD + " TEXT, "
                + EMAIL_ID + " TEXT" + ")";
    ...
    void insert(String name,String emailId,String pass)
    {
    ...
    //to the result set returned by a database query.
    {
        ...
        return db.query(TABLE_CONTACTS, new String[] {KEY_ID,KEY_NAME,EMAIL_ID,PASS_WORD},
